...
def main():
    ...
    dataset_id = f"{cfg.PROJECT_ID}.{cfg.DATASET_NAME}"

    ensure_dataset(client, dataset_id, cfg.GOOGLE_CLOUD_LOCATION)
    print(f"✅ Dataset ready: {dataset_id} [{cfg.GOOGLE_CLOUD_LOCATION}]")
